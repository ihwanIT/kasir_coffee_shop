...
// transaksi E wallet
// Route::get('/EwalletTransaction/{transactionID}', [PaymentController::class, 'getTransactionDetails'])->name('kasir.Ewallettransaksi');
Route::get('/EwalletTransaction', [PaymentController::class, 'getTransactionDetails'])->name('kasir.Ewallettransaksi');

Route::post('/transaksiEwallet', [PaymentController::class, 'pay'])->name('kasir.transaksiUpdateEwallet');
// deleted transaksi
