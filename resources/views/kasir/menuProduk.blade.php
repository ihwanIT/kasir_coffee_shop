...
@endphp
                ...
                <div class="modal-body">
                    <form action="{{ route('MenuProduk.create') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="recipient-name" name="harga" value="1" min="1" required>
                        </div>
                        <div class="mb-3">
                            <label for="recipient-name" class="col-form-label">Jumlah</label>
                            <input type="number" class="form-control" id="recipient-name" name="jumlah" value="1" min="1"  required>
                        </div>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button class="btn" type="submit" style="background-color: rgb(86, 86, 248); color:white">Tambah</button>
                </div>
                </form>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <form action="/MenuProduk" method="post">
                        ...
                        <div class="mb-3">
                            <label for="recipient-name" class="col-form-label">Nama Minuman</label>
                            <div class="input-group">
                              <select class="form-select" name="kategori" id="kategori" aria-label="Example select with button addon">
                                <option selected>Kategori</option>
                                <option value="Minuman">Minuman</option>               
                                <option value="Makanan">Makanan</option>               
                              </select>
    ...
    <div class="modal fade" id="hapus" data-bs-backdrop="static" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn" style="background-color: rgb(255, 112, 112); color:white;">Hapus</button>
                </div>
            </div>
        </div>
        </form>
    ...
    <h4 style="background-color: rgb(78, 78, 255); margin:0px; color:white; padding:10px; border-radius:0px 0px 20px 20px;">Menu</h4>
    {{-- search --}}
    <div class="search">
        <div>
            <button data-bs-target="#staticBackdrop" data-bs-toggle="modal"
                style="background-color:rgb(89, 89, 255); border:0; border-radius:5px; padding:5px 20px;">Tambah Menu <svg xmlns="http://www.w3.org/2000/svg" height="1em" fill="white" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM232 344V280H168c-13.3 0-24-10.7-24-24s10.7-24 24-24h64V168c0-13.3 10.7-24 24-24s24 10.7 24 24v64h64c13.3 0 24 10.7 24 24s-10.7 24-24 24H280v64c0 13.3-10.7 24-24 24s-24-10.7-24-24z"/></svg></button>
        </div>
        ...
        <tbody>
            @foreach ($menu as $item_menu)
                <tr>
                    ...
                    <td>
                            <button type="button" class="btn-edit" data-bs-target="#edit" data-bs-toggle="modal" data-myid="{{ $item_menu->id }}" data-myname="{{ $item_menu->nama }}" data-mykategori="{{ $item_menu->kategori }}" data-myharga="{{ $item_menu->harga }}" data-myjumlah="{{ $item_menu->jumlah }}" style="border: 0; background-color: rgb(255, 255, 96); font-size: small; border-radius: 20px; padding:5px;" id="edit">
                            ...
                            <button type="button" class="btn-edit" data-bs-target="#hapus" data-bs-toggle="modal" data-myid="{{ $item_menu->id }}" data-myname="{{ $item_menu->nama }}" data-mykategori="{{ $item_menu->kategori }}" data-myharga="{{ $item_menu->harga }}" data-myjumlah="{{ $item_menu->jumlah }}" style="border: 0; background-color: rgb(255, 52, 52); color:white; font-size: small; border-radius: 20px; padding:5px;" id="hapus">
